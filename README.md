...
- File extensions changed to `.rhysida` when by socradar
...
![Test Environment](https://github.com/Kelvinchuks/Phishing-Detection-for-Health-Workers/blob/Kelvinchuks/Test%20environment.PNG)
